...
/**
 * Transaction history view — filters, results table, and the void dialog.
 *
 * Owns its own list and filter state through {@link useTransactionHistory}, so
 * it can be dropped into any container: the standalone Transaction History page
 * or the POS workspace's embedded "Transactions" view. It renders only the
 * content (no page title or outer page container), leaving surrounding chrome
 * to the caller.
 */
