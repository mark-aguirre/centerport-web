...
/**
 * Spring Data JPA repository for {@link UrinalysisRepeatTest} entities.
 *
 ...
 */
public interface UrinalysisRepeatTestRepository extends JpaRepository<UrinalysisRepeatTest, UUID> {

    /**
     * Finds all urinalysis repeat tests linked to a specific laboratory report.
     *
     * @param laboratoryReportId the parent laboratory report UUID
     * @param sort               sorting criteria
     * @return list of repeat tests for the given report
     */
    List<UrinalysisRepeatTest> findByLaboratoryReportId(UUID laboratoryReportId, Sort sort);
}
